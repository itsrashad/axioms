...
If you want to keep it simple, head over to https://axioms.app and generate your `axioms` based theme from there. You just input the name of the theme you want to create, click the "Generate" button, and you get your ready-to-awesomize starter theme.
...
Axioms includes support for Infinite Scroll in Jetpack.
